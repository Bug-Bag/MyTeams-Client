...
export const SigninPageFC: React.FC<ISigninPageProps> = (
    ...
    const onRegister = (): void => {
        ...
        requestPromise.then((res: UserResponse) => {console.log(res); setStatus(Status.Completed);})
            .catch((err: Error) => {console.log(err); setStatus(Status.Failed);});
    }
    ...
    return (
        <Card className="signUpCard">
            ...
            <Button variant="text" color="secondary" onClick={() => {props.setIsSignIn(false)}}>Don't have an account? Register a new account now!</Button>
        </Card>
    );
};
